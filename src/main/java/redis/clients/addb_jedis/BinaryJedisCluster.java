...
import redis.clients.addb_jedis.commands.BinaryJedisClusterCommands;
import redis.clients.addb_jedis.commands.JedisClusterBinaryScriptingCommands;
import redis.clients.addb_jedis.commands.MultiKeyBinaryJedisClusterCommands;
...
import redis.clients.addb_jedis.util.KeyMergeUtil;
...
public class BinaryJedisCluster implements BinaryJedisClusterCommands,
  ...
  public Set<byte[]> getMeta(final byte[] pattern) {
	 System.out.println("getMeta in Binary Jedis Cluster");
